...
public class BaseActivity extends AppCompatActivity implements ActivityLifecycleProvider {
    ...
    @Override @NonNull @CheckResult public final Observable<ActivityEvent> lifecycle() {
    ...
    @Override @CallSuper protected void onCreate(@Nullable Bundle savedInstanceState) {
